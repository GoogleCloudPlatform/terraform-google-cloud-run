...
variable "members" {
  type        = list(string)
  description = "Users/SAs to be given invoker access to the service. This can be `allUsers`, `allAuthenticatedUsers` or any other Users/SAs. Please visit this link for seeing the complete list of Users/SAs https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/cloud_run_v2_service_iam#member/members-1."
  default     = []
}
