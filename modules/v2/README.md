...
| node\_selector | Node Selector describes the hardware requirements of the resources. | <pre>object({<br>    accelerator = string<br>  })</pre> | `null` | no |
