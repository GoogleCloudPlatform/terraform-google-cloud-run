...
| ssl | Enables the Post-Quantum Cryptography (PQC) SSL Policy for the Load Balancer (Requires TLS 1.3). | `bool` | `false` | no |
...
| ssl\_policy\_id | The ID of the created Post-Quantum SSL Policy, if enabled. |
